...
Процедура СформироватьНаСервере()
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	ПлановыеОтсутсвия.Сотрудник,
		|	ПлановыеОтсутсвия.ДатаНачала,
		|	ПлановыеОтсутсвия.ДатаОкончания,
		|	ПРЕДСТАВЛЕНИЕ(ПлановыеОтсутсвия.Сотрудник) КАК СотрудникПредставление,
		|	ПлановыеОтсутсвия.Регистратор
		|ИЗ
		|	РегистрСведений.ПлановыеОтсутсвия КАК ПлановыеОтсутсвия
		|ГДЕ
		|	ПлановыеОтсутсвия.ДатаНачала < &КонецПериода
		|	И ПлановыеОтсутсвия.ДатаОкончания > &НачалоПериод";
