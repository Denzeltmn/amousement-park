...
&НаСервере
Процедура КлиентПриИзменениеНаСервере()
...
Процедура ЗаполнитьДекорациюБаллыКлиента()
	...
	ЧастиФорматированойСтроки = Новый Массив; // Массив из Строка, ФорматированнаяСтрока
	ЧастиФорматированойСтроки.Добавить(Описание);
	ЧастиФорматированойСтроки.Добавить(Новый ФорматированнаяСтрока("Заполнить.", , , ,СсылкаЗаполненияБаллов));
	
	Элементы.ДекорацияБаллыКлиента.Заголовок = Новый ФорматированнаяСтрока(ЧастиФорматированойСтроки);
...
//  Структура - Значение перетаскивания товары:
