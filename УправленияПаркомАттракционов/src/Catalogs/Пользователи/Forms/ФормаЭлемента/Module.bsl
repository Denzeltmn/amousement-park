...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ИначеЕсли РольПользователя = Перечисления.РолиПользователей.ОператорАтракциона Тогда
...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	ИначеЕсли ЭтоОператорАттракциона Тогда
		РольПользователя = Перечисления.РолиПользователей.ОператорАтракциона;
	КонецЕсли;
...
Процедура УправлениеДоступностьюЭлементовФормы(Форма)
	...
	УправлениеПользователейДоступно = Форма.ДоступРазрешен;
	
	Форма.Элементы.Логин.Доступность = УправлениеПользователейДоступно;
	Форма.Элементы.ГруппаПароль.Доступность = УправлениеПользователейДоступно;
	Форма.Элементы.РольПользователя.Доступность = УправлениеПользователейДоступно;
