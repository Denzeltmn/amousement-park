...
// Билет.
// Формирует печатную форму билета на основании переданного документа.
//
// Параметры:
//  ТабДок - ТабличныйДокумент - объект табличного документа для вывода результата
//  Ссылка - ДокументСсылка.ПродажаБилета - ссылка на документ "Продажа билета"
...
// Переносит значения из реквизитов и новую табличную часть
