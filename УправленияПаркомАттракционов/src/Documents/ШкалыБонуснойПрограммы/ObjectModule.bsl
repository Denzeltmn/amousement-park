...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	// 1. Нижняя граница периого диапазона долана быть равна 0
	...
	// 4. Верхняя граница последнего диапизона должни быть равна 0
	...
	Для Сч = 0 По Диапазоны.Количество() - 1 Цикл
		...
		Если Диапазон.НижняяГраница > Диапазон.ВерхняяГраница 
			...
			Отказ = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = СтрШаблон("Верхняя граница должна быть больше нижней границе");
			Сообщение.УстановитьДанные(ЭтотОбъект);
